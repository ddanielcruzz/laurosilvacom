---
title: Ordered collection or list containing zero or more datatypes
slug: a-modern-development-workflow-using-netlify-codesandbox-2
image: ./images/1.png
...
```bash{promptUser: laurosilvacom}{promptHost: localhost}
npm install react
```
