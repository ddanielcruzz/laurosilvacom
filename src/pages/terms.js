...
const Terms = () => (
  <Layout>
    <SEO
      ...
      keywords={[`terms`, `privacyy`, `policy`]}
    />
    <HeroContent>
    ...
    <Content>
      ...
      <ol>
        <li>
          ...
          materials (information or software) on Rubydock, LLC.'s website for
        ...
        <li>
          ...
          restrictions and may be terminated by Rubydock, LLC. at any time. Upon
      ...
      <ol>
        <li>
          The materials on Rubydock, LLC.'s website are provided on an 'as is'
          basis. Rubydock, LLC. makes no warranties, expressed or implied, and
        ...
        <li>
          Further, Rubydock, LLC. does not warrant or make any representations
      ...
      <h3>4. Limitations</h3>
      <p>
        In no event shall Rubydock, LLC. or its suppliers be liable for any
        damages (including, without limitation, damages for loss of data or
        profit, or due to business interruption) arising out of the use or
        inability to use the materials on Rubydock, LLC.'s website, even if
        Rubydock, LLC. or a Rubydock, LLC. authorized representative has been
      ...
      <p>
        The materials appearing on Rubydock, LLC.'s website could include
        technical, typographical, or photographic errors. Rubydock, LLC. does
        not warrant that any of the materials on its website are accurate,
        complete or current. Rubydock, LLC. may make changes to the materials
      ...
      <h3>6. Links</h3>
      <p>
        Rubydock, LLC. has not reviewed all of the sites linked to its website
        and is not responsible for the contents of any such linked site. The
        inclusion of any link does not imply endorsement by Rubydock, LLC. of
        the site. Use of any such linked website is at the user's own risk.
      </p>
      <h3>7. Modifications</h3>
      <p>
        Rubydock, LLC. may revise these terms of service for its website at any
      ...
      <p>
        Your privacy is important to us. It is Rubydock, LLC.'s policy to
        respect your privacy regarding any information we may collect from you
        across our website,{' '}
        <a href="https://laurosilva.com/">https://laurosilva.com/</a>, and other
      ...
      <p>This policy is effective as of 6 April 2019.</p>
    </Content>
  </Layout>
)
